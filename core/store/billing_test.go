...
func TestGetUserBilling_Found(t *testing.T) {
	...
	rows := sqlmock.NewRows([]string{
		...
		"overlimit_since", "traffic_ceiling_gb", "traffic_billing_enabled", "updated_at",
	}).AddRow("user-1", "past_due", grace, nil, "48h", "", "", nil, 5, nil, nil, nil, nil, "", nil, nil, nil, nil, int64(0), false, now)
...
func TestListUserBillingByStatus_HappyPath(t *testing.T) {
	...
	rows := sqlmock.NewRows([]string{
		...
		AddRow("user-1", "suspended", nil, now, "", "", "", nil, nil, nil, nil, nil, nil, "", nil, nil, nil, nil, int64(0), false, now).
		AddRow("user-2", "suspended", nil, now, "", "", "", nil, nil, nil, nil, nil, nil, "", nil, nil, nil, nil, int64(0), false, now)
...
func TestListUserBillingByStatus_ScanErrorPropagates(t *testing.T) {
	...
	rows := sqlmock.NewRows([]string{
		...
		AddRow("user-1", "suspended", nil, nil, "", "", "", nil, nil, nil, nil, nil, nil, "", nil, nil, nil, nil, int64(0), false, "not-a-time")
