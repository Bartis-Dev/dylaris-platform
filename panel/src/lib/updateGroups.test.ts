...
describe('anythingOutdated', () => {
    it('is true when any component is behind', () => {
        expect(anythingOutdated([
            { key: 'core', service: 'core', outdated: false, countable: true, instances: [] },
            { key: 'node', service: 'node', outdated: true, countable: true, instances: [] },
        ])).toBe(true);
    });
    it('is false for an empty or current fleet', () => {
        expect(anythingOutdated([])).toBe(false);
        expect(anythingOutdated([{ key: 'core', service: 'core', outdated: false, countable: true, instances: [] }])).toBe(false);
    });
});
