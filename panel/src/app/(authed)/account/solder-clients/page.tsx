...
export default function SolderClientsPage() {
    ...
    // this flag the page would invite the user to create a client the API is
                ...
                <div className="card p-4 mb-4 text-xs flex items-start gap-2">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-(--base-06)">
                            New clients cannot be created and existing ones are already being refused, because Solder serves modpacks. An admin can re-enable them under Settings &rarr; Features.
                        </p>
                    </div>
                </div>
            )}
